...
/*
First creat all the background density graphics,
Then take the PImage and slice it,
Then look at the brightness of the sliced pixels and replace them with the pixels from the background density graphics
*/
